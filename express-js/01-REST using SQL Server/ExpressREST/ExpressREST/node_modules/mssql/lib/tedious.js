  ...
  module.exports = function(Connection, Transaction, Request, ConnectionError, TransactionError, RequestError) {
    ...
    TediousRequest = (function(superClass) {
      ...
      TediousRequest.prototype.query = function(command, callback) {
        var batchHasOutput, batchLastRow, columns, errors, handleError, isJSONRecordset, jsonBuffer, recordset, recordsets, started;
        columns = {};
        recordset = [];
        recordsets = [];
        started = Date.now();
      ...
      TediousRequest.prototype.execute = function(procedure, callback) {
        var columns, errors, handleError, isJSONRecordset, jsonBuffer, recordset, recordsets, returnValue, started;
        columns = {};
        recordset = [];
        recordsets = [];
        returnValue = 0;
